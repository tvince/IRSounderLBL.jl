"""
ARTS 2.6 LBL validation with H2O MT-CKD 3.50 continuum.

Same setup as arts_validation.py but with APPLY_CONTINUUM = True.
Output: data/arts_bt_iasi_cont.csv  (do NOT overwrite arts_bt_iasi.csv).

Run with:
  /opt/homebrew/Caskroom/miniconda/base/envs/arts_env/bin/python scripts/arts_validation_cont.py
"""
...
print(f"  Continuum: ON  (H2O-SelfContCKDMT350 + H2O-ForeignContCKDMT350)")
