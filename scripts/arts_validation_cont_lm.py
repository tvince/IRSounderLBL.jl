...
Narrowed to CO2 15 µm band (645–800 cm⁻¹) for speed.
Line mixing uses HITRAN 2020 relaxation matrix data (VP_Y mode, first-order
Rosenkranz) from data/Line-mixing_HITRAN2020/data_new/.

Output: data/arts_bt_co2_15um_lm.csv

Run with:
  /opt/homebrew/Caskroom/miniconda/base/envs/arts_env/bin/python scripts/arts_validation_cont_lm.py
"""
...
OUT_FILE = os.path.join(DATA_DIR, "arts_bt_co2_15um_lm.csv")
...
print("  Line mixing: ON  (HITRAN 2020, VP_Y, 645–800 cm⁻¹)")
